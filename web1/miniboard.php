...
<!DOCTYPE html>
<head>
	<link rel="stylesheet" type="text/css" href="../board/boardstyle.css"/>
</head>
<div>
	<div>
		<p>
			<div>
				<center>
					<a href="../board/board.php" style="font-size:20px"> 자유게시판 </a>
				</center>
				<table id="boardtable" style="margin-top:10px;">
					<tr id="info">
