					...
					<table id="boardWrite">
						...
						<tbody>
							<tr>
								...
								<td class="title">
									<input type="text" name="bTitle" id="bTitle" style="height:20px; width:300px;">
								</td>
							</tr>
							<tr>
								<th scope="row">
								...
								<td class="content">
									<textarea name="bContent" id="bContent" style="margin: 0px; width: 1358px; height:500px;"></textarea>
								</td>
							</tr>
						</tbody>
					</table>
