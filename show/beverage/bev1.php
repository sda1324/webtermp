...
<?
    ...
    $sql = "select * from beverage where name='$check'";
            ...
            <div id="detail">
                ...
                <div id="detailsum">
                    <div id="suminner">
                        ...
                        <h3> 영양 정보 </h3>
                        <table>
                            <tr> <td style="background-color: #eeeded;">1회 제공량(ml)</td> <td style="border: 1px solid #eeeded; text-align: right;"><?=$serve?> ml</td></tr>
                            ...
                            <tr> <td style="background-color: #eeeded;">탄수화물(g)</td> <td style="border: 1px solid #eeeded;text-align: right;"><?=$tan?> g</td> </tr>
